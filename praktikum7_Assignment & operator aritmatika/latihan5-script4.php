<html>
    ...
    <body>
        ...
        ke dalam satuan jan-menit-detik.
        Diketahui waktu dalam detik adalah 15789 detik, akan dikonversi ke bentuk jam, y menit dan z detik
        */
        $totalDetik = 15789; // jumlah total detik mula-mula
        // mencari waktu dalam jan
        $sisa = $totalDetik % 3600;
        $dalamJam = ($totalDetik - $sisa) / 3600;
        // sisa dari perhitungan jan digunakan untuk menghitung menitnya
        $totalDetik = $sisa;
        $sisa = $totalDetik % 60;
